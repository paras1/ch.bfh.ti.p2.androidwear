...
\def \title			{Anhang: Evaluation Wearables}		% Title
\def \version		{1.0}
...
%---------------------------------------------------------------------------
\include{00_Vorspann/01_Titelseite}
\cleardoubleemptypage
\setcounter{page}{1}
\include{00_Vorspann/02_Vorwort}
%---------------------------------------------------------------------------
...
%---------------------------------------------------------------------------
\onecolumn
\include{02_Analyse_des_Wearable_Marktes/01_Analyse_WearableMarkt}
%-Included in 01_Analyse_WearableMarkt: 03_Teil_2/02_Feature_Tabelle

% Main part - Part III
%---------------------------------------------------------------------------
\onecolumn
\include{03_Evaluation_von_Applikationen/01_Evaluation_Applikationen}
% Attachment:
%---------------------------------------------------------------------------
