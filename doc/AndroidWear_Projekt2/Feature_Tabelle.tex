...
\begin{longtable}{p{3cm}p{4cm}p{4cm}p{4cm}p{4cm}p{4cm}}
	...
	% Header
	& \rotatebox{90}{Huawei Watch} \includegraphics{images/huawei_watch}
	& \rotatebox{90}{Sony SmartWatch 3} \includegraphics{images/sony_smartwatch_3}
	& \rotatebox{90}{Samsung Gear S} \includegraphics{images/samsung_gear_s}
	& \rotatebox{90}{Samsung Gear Live} \includegraphics{images/samsung_gear_live}
	& \rotatebox{90}{Asus ZenWatch} \includegraphics{images/asus_zen_watch} \\
	\hline
	\endfirsthead
